...
const envSchema = z.object({
  ...
  OPENROUTER_PRIMARY_MODEL: z.string().min(1).default('stealth/space-bunny-alpha'),
  OPENROUTER_FALLBACK_MODEL: z.string().min(1).default('xiaomi/mimo-v2.5'),
  OPENROUTER_REQUEST_TIMEOUT_MS: z.coerce.number().int().min(5_000).max(45_000).default(25_000),
